    ...
    $('.github-widget').each(function () {
        ...
        $.ajax({
            ...
            success: function (results) {
                ...
                if (repo.message) {
                    if ("Not Found" == repo.message) {
                        return;
                    }
                    if (repo.message.indexOf("limit") > 0) {
                        return;
                    }
                }
                ...
                var $widget = $(' \
					<div class="github-box repo">  \
					    <div class="github-box-title"> \
					        ...
					        <a class="watchers" title="Watchers" href="' + repo.url.replace('api.', '').replace('repos/', '') + '/watchers" target="_blank">Watch ' + repo.subscribers_count + '</a><a class="watchers" title="Watchers" href="' + repo.url.replace('api.', '').replace('repos/', '') + '/stargazers" target="_blank">Star ' + repo.watchers + '</a><a class="forks" title="Forks" href="' + repo.url.replace('api.', '').replace('repos/', '') + '/network" target="_blank">Fork ' + repo.forks + '</a>\
					        </div> \
					    </div> \
