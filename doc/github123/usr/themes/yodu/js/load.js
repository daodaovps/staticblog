...
$.extend({
    ...
    Sousuo: function () {
        ...
        // $("#keyword").focus();
        window.setTimeout("document.getElementById('keyword').focus();", 50)  ;
    },
...
function hitokoto() {
    if ($("#hitokoto")) {
        $.ajax({
            url: 'https://kotori.sinaapp.com/hitokoto/json',
            type: 'get',
...
(function () {
    ...
    $("#indexmain  .post").click(function (t) {
